...
# 0) BACKUP
# ------------------------------------------------------------
$backupRoot = Join-Path $repo ("backups\mod2i_" + (Get-Date -Format "yyyyMMdd_HHmmss"))
...
# ------------------------------------------------------------
# 5) Reemplazar waSendH / waSendMultiH
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# 7) Insertar endpoint /internal/operator-send
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# 9) Reemplazar bloque reset completo
# ------------------------------------------------------------
...
Info "pushLeadEvent agregado en zhUpsert"

# ------------------------------------------------------------
# 11) Insertar pushQuoteEvent después del catch del bloque formal
# ------------------------------------------------------------
...
Ok "M2I aplicado correctamente."
Write-Host ""
Write-Host "Siguiente paso:"
Write-Host "  git add ."
Write-Host '  git commit -m "mod2i integrate sales os bridge and operator handoff"'
Write-Host "  git push"